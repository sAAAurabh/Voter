    ...
    , voter_nid(nid)
{
    ...
    name_label = new QLabel(QString::fromStdString("Name: " + v.first + " " + v.last));
    nid_label = new QLabel(QString::fromStdString("NID: " + v.nid));
    gender_label = new QLabel(QString::fromStdString("Gender: " + v.gender));
    dob_label = new QLabel(QString::fromStdString("Date of Birth: " + v.dob));
