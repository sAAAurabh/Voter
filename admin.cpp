...
{
    {
        ...
        q.prepare("INSERT INTO voters "
                  "(nid, first, last, dob, gender, password_hash, salt, photo_path, has_voted, "
                  "is_locked, attempts_left) "
                  "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
...
void Admin::add_candidate(const Candidate &c)
{
    {
        QSqlQuery q(Database::db);
        q.prepare("INSERT INTO candidates "
                  "(nid, first, last, party, dob, gender, password_hash, salt, photo_path, votes, "
                  "is_locked, attempts_left) "
                  "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
...
{
    {
        ...
        q.prepare("UPDATE candidates SET "
                  "first = ?, "
                  "last = ?, "
                  "salt = ?, "
                  "password_hash = ?, "
